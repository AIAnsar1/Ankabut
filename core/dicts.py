...
from .enums import ContentType, DBMS, OS, PostHint
...
PART_RUN_ContentTypeS = {
    "checkDbms": ContentType.TECHNIQUES,
    "getFingerprint": ContentType.DBMS_FINGERPRINT,
    "getBanner": ContentType.BANNER,
    "getCurrentUser": ContentType.CURRENT_USER,
    "getCurrentDb": ContentType.CURRENT_DB,
    "getHostname": ContentType.HOSTNAME,
    "isDba": ContentType.IS_DBA,
    "getUsers": ContentType.USERS,
    "getPasswordHashes": ContentType.PASSWORDS,
    "getPrivileges": ContentType.PRIVILEGES,
    "getRoles": ContentType.ROLES,
    "getDbs": ContentType.DBS,
    "getTables": ContentType.TABLES,
    "getColumns": ContentType.COLUMNS,
    "getSchema": ContentType.SCHEMA,
    "getCount": ContentType.COUNT,
    "dumpTable": ContentType.DUMP_TABLE,
    "search": ContentType.SEARCH,
    "sqlQuery": ContentType.SQL_QUERY,
    "tableExists": ContentType.COMMON_TABLES,
    "columnExists": ContentType.COMMON_COLUMNS,
    "readFile": ContentType.FILE_READ,
    "writeFile": ContentType.FILE_WRITE,
    "osCmd": ContentType.OS_CMD,
    "regRead": ContentType.REG_READ
}
