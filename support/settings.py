import codecs, os, random, string, sys, time, re
...
o88o     o8888o o888o o888o o888o o888o `Y888""8o  `Y8bod8P'  `V88V"V8P'   "888" 
...
DBMS_DIRECTORY_DICT = dict((getattr(DBMS, _), getattr(DBMSDirectoryName, _)) for _ in dir(DBMS) if not _.startswith("_"))
