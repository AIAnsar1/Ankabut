...
class DBMSDirectoryName(object):
    ACCESS = "access"
    DB2 = "db2"
    FIREBIRD = "firebird"
    MAXDB = "maxdb"
...
class ReflectiveCounter(object):
    MISS = "MISS"
    HIT = "HIT"
...
class RegistryOperation(object):
    READ = "read"
    ADD = "add"
    DELETE = "delete"
