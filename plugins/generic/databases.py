...
from core.data import conf, kb, logger, paths, queries
from core.decorators import stackedmethod
from core.dicts import ALTIBASE_TYPES, FIREBIRD_TYPES, INFORMIX_TYPES
from core.enums import CharsetType, DBMS, Expected, Fork, Payload
from core.exceptions import AnkabMissingMandatoryOptionException, AnkabNoneDataException, AnkabUserQuitException
from core.settings import CURRENT_DB, METADB_SUFFIX, PLUS_ONE_DBMSES, REFLECTED_VALUE_MARKER, UPPER_CASE_DBMSES, VERTICA_DEFAULT_SCHEMA
from request import inject
from support.brute import columnExists, tableExists
from pkg import six
...
class Databases(object):
    ...
    def _tableGetCount(self, db, table):
        ...
        count = inject.getValue(query, expected=Expected.INT, charsetType=CharsetType.DIGITS)
