...
from core.common import Backend, hashDBWrite, isStackingAvailable, normalizePath, ntToPosixSlashes, posixToNtSlashes, readInput, singleTimeDebugMessage, unArrayizeValue
from core.data import conf, kb, logger, queries
from core.enums import DBMS, HASHDBKeys, OS
...
class Miscellaneous(object):
    ...
    def getRemoteTempPath(self):
        ...
        hashDBWrite(HASHDBKeys.CONF_TMP_PATH, conf.tmpPath)
