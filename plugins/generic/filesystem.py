...
from core.convert import encodeBase64, encodeHex, getText, getUnicode
...
class Filesystem(object):
    ...
    def _checkFileLength(self, localFile, remoteFile, fileRead=False):
        ...
        if fileRead and Backend.isDbms(DBMS.PGSQL):
            ...
            remoteFileSize = inject.getValue(lengthQuery, resumeValue=False, expected=Expected.INT, charsetType=CharsetType.DIGITS)
            sameFile = None
