...
from core.exceptions import AnkabMissingMandatoryOptionException, AnkabUserQuitException
from core.settings import CURRENT_DB, METADB_SUFFIX, UPPER_CASE_DBMSES
